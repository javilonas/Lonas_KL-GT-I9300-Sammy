...
#define MALI_MAX_VOLTAGE        1300000
...
mali_dvfs_table mali_dvfs[MALI_DVFS_STEPS]={
        ...
        {533   ,1000000   , 1100000}, // L3
        {440   ,1000000   , 1037500}, // L4
        {350   ,1000000   ,  975000}, // L5
        {266   ,1000000   ,  925000}, // L6
        {160   ,1000000   ,  900000}, // L7
...
static unsigned int asv_3d_volt_9_table[MALI_DVFS_STEPS][ASV_LEVEL_PRIME] = {
        { 1100000, 1087500, 1075000, 1062500, 1050000, 1037500, 1025000, 1012500, 1025000, 1012500,  987500,  975000,  962500},        /* L3(533Mhz) */
        { 1037500, 1025000, 1012500, 1000000,  987500,  975000,  962500,  950000,  962500,  950000,  925000,  912500,  900000},        /* L4(440Mhz) */
        {  975000,  962500,  950000,  937500,  925000,  912500,  900000,  887500,  900000,  887500,  862500,  850000,  837500},        /* L5(350Mhz) */
        {  925000,  912500,  900000,  887500,  875000,  862500,  850000,  837500,  850000,  837500,  825000,  825000,  825000},        /* L6(266Mhz) */
        {  900000,  887500,  875000,  862500,  850000,  837500,  825000,  812500,  825000,  812500,  800000,  800000,  800000}, /* L7(160Mhz) */
};
#endif /* ASV_LEVEL */
