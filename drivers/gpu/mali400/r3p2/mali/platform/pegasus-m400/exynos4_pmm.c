...
mali_dvfs_table mali_dvfs[MALI_DVFS_STEPS]={
			...
			/* step 2 */{350  ,1000000	,925000	   ,85   , 90},
			/* step 3 */{440  ,1000000	,1000000   ,85   , 90},
			/* step 4 */{533  ,1000000	,1050000   ,95   ,100} };
#else
			/* step 0 */{134  ,1000000	,925000    ,0   , 70},
			/* step 1 */{267  ,1000000	,1025000   ,65   ,90},
			/* step 2 */{400  ,1000000      ,1175000   ,85   ,100} };
#endif
...
static unsigned int asv_3d_volt_9_table_for_prime[MALI_DVFS_STEPS][ASV_LEVEL_PRIME] = {
	{  937500,  912500,  900000,  887500,  875000,  862500,  850000,  837500,  850000,  837500,  825000,  825000,  825000},  /* L4(160Mhz) */
#if (MALI_DVFS_STEPS > 1)
	{  962500,  937500,  925000,  912500,  900000,  887500,  875000,  862500,  875000,  862500,  850000,  850000,  850000}, /* L3(266Mhz) */
#if (MALI_DVFS_STEPS > 2)
	{ 1012500, 987500, 975000,  962500,  950000,  937500,  925000,  912500,  925000,  912500,  887500,  875000,  862500}, /* L2(350Mhz) */
#if (MALI_DVFS_STEPS > 3)
	{ 1075000, 1050000, 1037500, 1025000, 1012500, 1000000, 987500, 975000, 987500, 975000,  950000,  937500,  925000}, /* L1(440Mhz) */
#if (MALI_DVFS_STEPS > 4)
	{ 1137500, 1112500, 1100000, 1087500, 1075000, 1062500, 1050000, 1037500, 1050000, 1037500, 1012500, 1000000, 987500}, /* L0(533Mhz) */
#endif
#endif
#endif
#endif
...
static unsigned int asv_3d_volt_4210_12_table[MALI_DVFS_STEPS][ASV_LEVEL_4210_12] = {
	{  975000,  975000,  975000,   925000,   925000,   925000,   925000,   925000},	/* L2(134Mhz) */
#if (MALI_DVFS_STEPS > 1)
	{  1075000,  1075000,  1075000,  975000,  975000,  975000,  975000,   925000},	/* L1(266Mhz) */
#if (MALI_DVFS_STEPS > 2)
	{  1175000,  1175000,  1175000,  1075000,  1075000,  1075000,  1025000,  1025000},	/* L0(400Mhz) */
#endif
#endif
};

static unsigned int asv_3d_volt_4210_14_table[MALI_DVFS_STEPS][ASV_LEVEL_4210_14] = {
	{  975000,  975000,   925000,   925000,   925000},	/* L2(134Mhz) */
#if (MALI_DVFS_STEPS > 1)
	{  1075000,  1075000,  975000,  975000,   925000},	/* L1(266Mhz) */
#if (MALI_DVFS_STEPS > 2)
	{  1175000,  1175000,  1075000,  1025000,  1025000},	/* L0(400Mhz) */
#endif
#endif
};
#endif
